...
public class CommandFazerReserva implements Command{

    FachadaBiblioteca fachada;
    
    public CommandFazerReserva(FachadaBiblioteca fachada) {
    ...
    public void execute(List<String> args) {
        ...
        result = this.fachada.fazerReserva(idUsuario, idLivro);
